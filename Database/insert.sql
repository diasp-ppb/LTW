...
INSERT INTO Restaurants (name, address, type, city, district, country,description, avgClass) VALUES('Hard Rock Cafe', 'Rua do Dr. Artur de Magalhães Basto 38', 'Americano', 'Porto', 'Porto', 'Portugal','Rede de restaurantes com tema rock’n’roll e ambiente vibrante que serve hambúrgueres e clássicos americanos.', 4.9);
...
INSERT INTO Restaurants (name, address, type, city, district, country,description, avgClass) VALUES('Da Mattia Pizzeria Italiana', 'R. do Monte Alegre 113', 'Italiana', 'Porto', 'Porto', 'Portugal','Na emblemática cidade Invicta, encontra a Da Mattia Pizzeria Italiana, que abriu portas em Março de 2016.
